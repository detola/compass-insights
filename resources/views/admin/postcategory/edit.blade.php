                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <h5 class="card-title">Edit Category</h5>
                                            {!! Form::model($postcategory, ['method'=>'PATCH', 'action'=> ['CategoryController@update', $postcategory->id]]) !!}
                                            {{ csrf_field() }}
            								...
            								{!! Form::close() !!}
                                            {!! Form::open(['method'=>'DELETE', 'action'=> ['CategoryController@destroy', $postcategory->id]]) !!}
